...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Shop_Store.Domain.Entities.Carts.Cart", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("Shop_Store.Domain.Entities.Carts.CartItem", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("Shop_Store.Domain.Entities.Finances.RequestPay", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("Shop_Store.Domain.Entities.Orders.Order", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("Shop_Store.Domain.Entities.Orders.OrderDetail", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("Shop_Store.Domain.Entities.Carts.CartItem", b =>
                {
                    b.HasOne("Shop_Store.Domain.Entities.Carts.Cart", "Cart")
                        .WithMany("CartItems")
            ...
            modelBuilder.Entity("Shop_Store.Domain.Entities.Orders.Order", b =>
                {
                    b.HasOne("Shop_Store.Domain.Entities.Finances.RequestPay", "RequestPay")
                        .WithMany("Orders")
            ...
            modelBuilder.Entity("Shop_Store.Domain.Entities.Orders.OrderDetail", b =>
                {
                    b.HasOne("Shop_Store.Domain.Entities.Orders.Order", "Order")
                        .WithMany()
